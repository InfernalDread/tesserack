...
traverse_effect_tree_fn = function(root, effects, render_effects) {
  ...
  while (effect2 !== null) {
    ...
    if (async_mode_flag && pending_boundary === null && (flags2 & BOUNDARY_EFFECT) !== 0 && ((_a = effect2.b) == null ? void 0 : _a.is_pending)) {
...
function run2(thunks) {
  ...
  for (const fn of thunks.slice(1)) {
    promise = promise.then(() => {
      ...
      var _a;
      unset_context();
      (_a = current_batch) == null ? void 0 : _a.deactivate();
    });
...
function update_derived(derived2) {
  ...
  if (!derived2.equals(value)) {
    ...
    if (!((_a = current_batch) == null ? void 0 : _a.is_fork) || derived2.deps === null) {
      derived2.v = value;
  ...
  if (!source2.equals(value)) {
    ...
    if (true_default) {
      if (tracing_mode_flag || active_effect !== null) {
        ...
        const count = (((_a = source2.updated.get("")) == null ? void 0 : _a.count) ?? 0) + 1;
...
//# sourceMappingURL=chunk-3DN4NXDP.js.map
